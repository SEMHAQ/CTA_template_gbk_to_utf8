%中文latax模版 (UTF-8 版本, 使用 xeCJK, Overleaf 兼容)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  xeCJK 字体设置
%    使用 Fandol 字体 (TeX Live 自带, Overleaf/Linux/Windows 均可用)
%    如本地有 SimSun 等 Windows 字体, 可改用 utf8/ 版本
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setCJKmainfont[BoldFont={FandolHei},ItalicFont={FandolKai}]{FandolSong}
\setCJKsansfont{FandolHei}
\setCJKmonofamily{FandolFang}
\newCJKfamily{song}{FandolSong}    % 宋体
\newCJKfamily{hei}{FandolHei}      % 黑体
\newCJKfamily{kai}{FandolKai}      % 楷体
\newCJKfamily{fsong}{FandolFang}   % 仿宋
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  lengths
